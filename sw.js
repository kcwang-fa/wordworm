const CACHE_NAME = 'wordworm-pwa-20260713f';
...
const PRECACHE_URLS = [
  ...
  './favicon.ico',
  './css/base.css?v=20260713f',
  './css/adventure.css?v=20260713a',
  './css/board.css?v=20260713a',
  './css/gameover.css?v=20260713a',
  './css/daily-kids.css?v=20260713f',
  './css/word-of-day.css?v=20260713a',
  './js/story.js',
  './js/adventure-data.js',
  './js/daily.js',
  './js/game-core.js?v=20260713f',
  './js/game-audio.js?v=20260713f',
  './js/game-save.js?v=20260713f',
  './js/game-board.js?v=20260713f',
  './js/game-classic.js?v=20260713f',
  './js/game-adventure.js?v=20260713f',
  './js/game-adventure-map.js?v=20260713f',
  './js/game-sync.js?v=20260713f',
  './js/game-boot.js?v=20260713f',
  './js/kids.js?v=kids-20260712b',
  './js/word-of-day.js?v=wotd-20260712b',
  './enable1.txt?v=20260712f',
  './modern-words.txt?v=20260712f',
  './extra-words.txt?v=20260712f',
  './daily_words.json',
  ...
  './assets/home-cover.png?v=20260712f',
